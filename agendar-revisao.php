        ...
        <div class="row margin-section">
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="contact-departments contact-version clearfix">
              <div class=" owl-theme">
                <div>
                  <p>Os serviços realizados na Starfor, no seu veículo, são totalmente confiáveis e tem a qualidade Ford e a garantia Starfor.</p>
                  <p>Cada vez mais a Starfor tem se preocupado em manter a qualidade dos seus serviços e a confiança aos nossos clientes. Veja alguns itens que são avaliados toda vez que seu veículo entra na Starfor:</p>
                  <ul>
                    <li>Pneus</li>
                    <li>Pastilhas de Freio</li>
                    <li>Bicos injetores</li>
                    ...
                    <li>Nível de óleo do motor</li>
                    <li>Trio elétrico</li>
                    <li>Nível do fluido do radiador</li>
                  </ul>
                </div>
              </div>
            ...
            <div class="search-tab lightversion clearfix">
              <div class="search-wrapper">
                ...
                <form class="row" name="form">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <input ng-model="dados.tmp.data" ng-disabled="load" ng-required="true" type="text" type="text" mask="99/99/99" placeholder="Melhor Data*" class="form-control">
                  </div>

                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <textarea ng-model="dados.tmp.mensagem" ng-disabled="load" ng-required="true" class="form-control" placeholder="Mensagem*"></textarea>
                  </div>
    ...
    angular.module('app', ['ngMask', 'ngDialog'])
      .controller('Lead', function($scope, $log, $http, $location, ngDialog, $httpParamSerializerJQLike) {
        ...
        $scope.enviarLead = function(dados, tmp = null) {
          ...
          dados.LE_Descricao = 'Melhor Data: '+dados.tmp.data+'\nMensagem: '+dados.tmp.mensagem;
          delete dados.tmp;
